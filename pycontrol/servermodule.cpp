...
static PyObject *playerHasFlag(PyObject *self, PyObject *args)
{
	int cn;
	server::clientinfo *ci;
	if(!PyArg_ParseTuple(args, "i", &cn))
...
static PyObject *cutMinutes(PyObject *self, PyObject *args)
{
	int mm;
	if(!PyArg_ParseTuple(args, "i", &mm))
		return 0;
	server::gamelimit -= mm * 60000;
	Py_INCREF(Py_None);
	return Py_None;
}
...
static PyMethodDef ModuleMethods[] = {
	...
	{"cutMinutes", cutMinutes, METH_VARARGS, "Cut minutes."},
