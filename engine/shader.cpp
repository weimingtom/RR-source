...
void loadshaders()
{
    ...
    if(!nullshader)fatal("cannot find nullshader definitions"); if(!defaultshader)fatal("cannot find defualtshader definitions"); if(!stdworldshader) fatal("cannot find stdshader definitions");
