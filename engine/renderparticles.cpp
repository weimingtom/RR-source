...
{
    new quadrenderer("<grey>@{tig/rr-core}/particle/blood.png", PT_GREY|PT_PART|PT_FLIP|PT_MOD|PT_RND4, DECAL_BLOOD), // blood spats (note: rgb is inverted)
    new trailrenderer("@{tig/rr-core}/particle/base.png", PT_TRAIL|PT_LERP),                            // water, entity
    new quadrenderer("<grey>@{tig/rr-core}/particle/smoke.png", PT_GREYALPHA|PT_PART|PT_FLIP|PT_LERP),  // smoke
    new quadrenderer("<grey>@{tig/rr-core}/particle/steam.png", PT_GREY|PT_PART|PT_FLIP),               // steam
    new quadrenderer("<grey>@{tig/rr-core}/particle/flames.png", PT_GREY|PT_PART|PT_HFLIP|PT_RND4|PT_BRIGHT),   // flame on - no flipping please, they have orientation
    new quadrenderer("@{tig/rr-core}/particle/ball1.png", PT_PART|PT_FEW|PT_BRIGHT),                    // fireball1
    new quadrenderer("@{tig/rr-core}/particle/ball2.png", PT_PART|PT_FEW|PT_BRIGHT),                    // fireball2
    new quadrenderer("@{tig/rr-core}/particle/ball3.png", PT_PART|PT_FEW|PT_BRIGHT),                    // fireball3
    new taperenderer("@{tig/rr-core}/particle/flare.jpg", PT_TAPE|PT_BRIGHT),                           // streak
    &lightnings,                                                                                   // lightning
    &fireballs,                                                                                    // explosion fireball
    &bluefireballs,                                                                                // bluish explosion fireball
    new quadrenderer("@{tig/rr-core}/particle/spark.png", PT_PART|PT_FLIP|PT_BRIGHT),                   // sparks
    new quadrenderer("@{tig/rr-core}/particle/base.png",  PT_PART|PT_FLIP|PT_BRIGHT),                   // edit mode entities
    new quadrenderer("@{tig/rr-core}/particle/snow.png", PT_PART|PT_FLIP|PT_RND4, -1),                  // colliding snow
    new quadrenderer("@{tig/rr-core}/particle/muzzleflash1.jpg", PT_PART|PT_FEW|PT_FLIP|PT_BRIGHT|PT_TRACK), // muzzle flash
    new quadrenderer("@{tig/rr-core}/particle/muzzleflash2.jpg", PT_PART|PT_FEW|PT_FLIP|PT_BRIGHT|PT_TRACK), // muzzle flash
    new quadrenderer("@{tig/rr-core}/particle/muzzleflash3.jpg", PT_PART|PT_FEW|PT_FLIP|PT_BRIGHT|PT_TRACK), // muzzle flash
    new quadrenderer("@{tig/rr-core}/texture/hud/items.png", PT_PART|PT_FEW|PT_ICON),                            // hud icon
    new quadrenderer("<colorify:1/1/1>@{tig/rr-core}/texture/hud/items.png", PT_GREY|PT_PART|PT_FEW|PT_ICON),    // grey hud icon
    &texts,                                                                                        // text
    &meters,                                                                                       // meter
    &metervs,                                                                                      // meter vs.
